...
def show_settings_screen():
    ...
    while True:
        ...
        panel_rect = pygame.Rect(86, 48, screen.get_width() - 172, screen.get_height() - 96)
        ...
        for index, (key, label, detail) in enumerate(toggle_specs):
            rect = pygame.Rect(panel_rect.x + 48, start_y + index * 78, panel_rect.width - 96, 62)
        ...
        music_slider_rect = pygame.Rect(panel_rect.x + 78, panel_rect.y + 448, panel_rect.width - 156, 18)
        sfx_slider_rect = pygame.Rect(panel_rect.x + 78, panel_rect.y + 528, panel_rect.width - 156, 18)
        ...
        helper_rect = pygame.Rect(panel_rect.x + 48, panel_rect.bottom - 104, panel_rect.width - 96, 54)
        ...
        helper_surface = small_font.render(helper_text, True, PALETTE["muted"])
        screen.blit(helper_surface, (helper_rect.x + 16, helper_rect.y + 18))

        back_rect = pygame.Rect(panel_rect.centerx - 90, panel_rect.bottom - 44, 180, 38)
